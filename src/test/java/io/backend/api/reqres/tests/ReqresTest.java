...
public class ReqresTest extends BaseTest {
    ...
    public void testPostalCodeDetails(String name, String job) {
        ...
        Assert.assertEquals(response.getStatusCode(), HttpStatuses.CREATED.getCode(),
                "Create User Success Status Code Failed!");
