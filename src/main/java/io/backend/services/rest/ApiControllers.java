...
public class ApiControllers {
    ...
    public PostalCodeDetailsResponse getPostalCodeDetailsResponse(String country, String pinCode) {
        return Failsafe.with(ApiConstants.RETRY_UTILS.getRetryPolicyForZipposTestException(2, 3)).get(() -> {
            ...
            if (zipposPostalCodeResponse.getStatusCode() != HttpStatuses.OK.getCode()) {
                ...
                throw new ApiTestException("Zippos Postal Code Details Status code mismatched!");
            }
    ...
    public CreateUserResponse getCreateUserResponse(String name, String job) {
        return Failsafe.with(ApiConstants.RETRY_UTILS.getRetryPolicyForReqresTestException(2, 3)).get(() -> {
            ...
            if (createUserResponse.getStatusCode() != HttpStatuses.CREATED.getCode()) {
                ...
                throw new ApiTestException("Reqres Create User status code mismatched!");
            }
    ...
    public RickAndMortyResponse getRickAndMortyResponse(int characterId) {
        return Failsafe.with(ApiConstants.RETRY_UTILS.getRetryPolicyForRickAndMortyTestException(2, 3)).get(() -> {
            ...
            if (rickAndMortyCharacterResponse.getStatusCode() != HttpStatuses.OK.getCode()) {
                ...
                throw new ApiTestException("Rick and Morty Get Character Details status code mismatched!");
            }
    ...
    public IfscCodeDetailsResponse getIfscCodeDetailsResponse(String ifscCode) {
        return Failsafe.with(ApiConstants.RETRY_UTILS.getRetryPolicyForIfscCodeTestException(2, 3)).get(() -> {
            ...
            if (ifscCodeResponse.getStatusCode() != HttpStatuses.OK.getCode()) {
                ...
                throw new ApiTestException("IFSC Code Details Status code mismatched!");
            }
    ...
    public GetAllProductListResponse getAllProductListResponse() {
        return Failsafe.with(ApiConstants.RETRY_UTILS.getRetryPolicyForAutomationExerciseException(2, 3)).get(() -> {
            ...
            if (productsListResponse.statusCode() != HttpStatuses.OK.getCode()) {
                ...
                throw new ApiTestException("Get All Products List status code mismatched!");
            }
